...
function Stony(){
    ...
    let display = `<div style="padding:5%;"><img src="images/chondrule.jpg" style="margin-left: 10%" width="80%" height="80%"><p class="infotext">Spherical chondrules in a meteorite</p></div>`
...
function StonyIron(){
    ...
    iron.style.background = "#5A5A5A"
    let display = `<div style="padding:5%;"><img src="images/Esquel.jpg" style="margin-left: 10%" width="80%" height="80%"><p class="infotext">A slice of Esqual pallasite</p></div>`
...
function Iron(){
    ...
    let display = `<div style="padding:5%;"><img src="images/TamentitMeteorite.png" style="margin-left: 10%" width="80%" height="80%"><p class="infotext">500kg Tamentit Iron Meteorite</p></div>`
...
function chondrite(){
    let display = `<div style="padding:5%;"><img src="images/StonyMeteorite.jpg" style="margin-left: 10%" width="80%" height="80%"><b class="infoheading">Chondrites:</b></div>`
    display += `<b class="infoheading">Carbonaceous Chondrite:</b>`
    display += `<p class="infotext">The high carbon prescence is due to a lack of exposure to high temperatures resulting in a hardly chaning from thermal processes.</p>`
    display += `<b class="infoheading">Ordinary Chondrite:</b>`
    display += `<p class="infotext">The most common type of metorite, comprising of over 85% of all recorded landings. This is due to the asteroids these meteorites originate from are much more suited at sending fragments to reach the surface of earth.</p>`
...
function achondrite(){
    let display = `<div style="padding:5%;"><img src="images/achondrite4.png" style="margin-left: 10%" width="80%" height="80%"><b class="infoheading">Achondrites:</b></div>`
